    ...
    >
      ...
      <div className="relative z-10">
        <div className="w-14 h-14 bg-stone-50 rounded-2xl flex items-center justify-center text-stone-900 mb-8 group-hover:scale-150 transition-transform duration-500">
          <span className="group-hover:text-[#C05621] transition-colors">{service.icon}</span>
        </div>
        <h3 className="text-2xl font-outfit font-semibold mb-4 text-stone-900 group-hover:text-[#C05621] transition-colors">{service.title}</h3>
...
const Skills: React.FC = () => {
  return (
    <section id="skills" className="py-16 scroll-mt-32">
      <div className="max-w-4xl mb-20">
        ...
        >
          ...
          <span className="text-[#b1b1b1ff] hover:text-[#C05621] transition-colors">People & Culture.</span>
        </motion.h2>
      </div>
